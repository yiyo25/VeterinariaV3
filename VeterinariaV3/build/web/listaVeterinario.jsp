            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Veterinario</h1>
                    </div>
                    <div>
                        <a href="veterinario.jsp" class="btn btn-sm btn-success"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>
                        <a href="listaVeterinario.jsp" class="btn btn-sm btn-warning"><i class="fas fa-list fa-sm text-white-50"></i> Listar</a>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                              <div class="card-body">
                                  <h5 class="card-title">Lista de Veterinarios</h5>
                                  <table class="table">
                                      <thead>
                                          <tr>
                                              <th scope="col">#</th>
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                 PreparedStatement ps = conexion.prepareStatement("SELECT * FROM usuario WHERE usuario_idTipoUsuario = '4'");
                                                 ResultSet rs = ps.executeQuery()) {

                                                while (rs.next()) {
                                        %>
                                                    <tr>
                                                        <th scope="row"><%= rs.getString("idUsuario") %></th>
                                                        <td><%= rs.getString("nomUsuario") %></td>
                                                        <td><%= rs.getString("dniUsuario") %></td>
                                                        <td><%= rs.getString("celUsuario") %></td>
                                                        <td><%= rs.getString("emaUsuario") %></td>
                                                        <td>
                                                            <a href="editarVeterinario.jsp?id=<%= rs.getString("idUsuario") %>" class="btn btn-sm btn-warning">
                                                                <i class="fas fa-pencil-alt fa-sm text-white-50"></i>
                                                            </a>

                                                            <a href="EliminarVeterinario?id=<%= rs.getString("idUsuario") %>" class="btn btn-sm btn-danger">
