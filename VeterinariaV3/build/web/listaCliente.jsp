                              ...
                              <div class="card-body">
                                  ...
                                  <table class="table">
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                 PreparedStatement ps = conexion.prepareStatement("SELECT * FROM usuario WHERE  usuario_idTipoUsuario = '1'");
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="actualizarEstado?id=<%= rs.getString("idUsuario")%>&estado=<%= rs.getString("estado") %>" class="btn btn-sm btn-success">
                                                                <i class="fa fa-exclamation-circle fa-sm text-white-50"></i>
                                                            </a>
                                                            <%} else {%>
                                                            <a href="actualizarEstado?id=<%= rs.getString("idUsuario")%>&estado=<%= rs.getString("estado") %>" class="btn btn-sm btn-danger">
                                                                <i class="fa fa-exclamation-circle fa-sm text-white-50"></i>
                                                            </a>
                                                            <%}%>                                                      
                                                        </td>
