        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="asistente.jsp" class="btn btn-sm btn-success"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>
                        <a href="listaAsistente.jsp" class="btn btn-sm btn-warning"><i class="fas fa-list fa-sm text-white-50"></i> Listar</a>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                              <div class="card-body">
                                  <h5 class="card-title">Lista de Asistentes</h5>
                                  <table class="table">
                                      <thead>
                                          <tr>
                                              <th scope="col">#</th>
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                 PreparedStatement ps = conexion.prepareStatement("SELECT * FROM usuario WHERE usuario_idTipoUsuario = '3'");
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="editarAsistente.jsp?id=<%= rs.getString("idUsuario") %>" class="btn btn-sm btn-warning">
                                                                <i class="fas fa-pencil-alt fa-sm text-white-50"></i>
                                                            </a>

                                                            <a href="eliminarAsistente?id=<%= rs.getString("idUsuario") %>" class="btn btn-sm btn-danger">
