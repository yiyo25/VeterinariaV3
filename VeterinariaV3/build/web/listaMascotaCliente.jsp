        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="registrarMascota.jsp" class="btn btn-sm btn-success"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>
                        <a href="listaMascotaCliente.jsp" class="btn btn-sm btn-warning"><i class="fas fa-list fa-sm text-white-50"></i> Listar</a>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                              <div class="card-body">
                                  <h5 class="card-title">Lista de Mascota</h5>
                                  <table class="table">
                                      <thead>
                                          <tr>
                                              <th scope="col">#</th>
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                 PreparedStatement ps = conexion.prepareStatement("SELECT * FROM mascota INNER JOIN tipo_mascota ON mascota.tipo_mascota_idTipo_mascota = tipo_mascota.idTipo_mascota WHERE usuario_idUsuario ="+idUsuario);
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%if(rs.getString("estadoMascota").equals("DESACTIVO")){ %>        
                                                            <a href="actualizarEstadoMascota?id=<%= rs.getString("idMascota")%>&estado=<%= rs.getString("estadoMascota") %>" class="btn btn-sm btn-danger">
                                                                <i class="fa fa-exclamation-circle fa-sm text-white-50"></i>
                                                            </a>
                                                            <%} else {%>
                                                            <a href="actualizarEstadoMascota?id=<%= rs.getString("idMascota")%>&estado=<%= rs.getString("estadoMascota") %>" class="btn btn-sm btn-success">
                                                                <i class="fa fa-exclamation-circle fa-sm text-white-50"></i>
                                                            </a>
                                                            <%}%>
                                                        </td>
