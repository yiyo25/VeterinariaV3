                              ...
                              <div class="card-body">
                                  ...
                                  <table class="table">
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                            PreparedStatement ps = conexion.prepareStatement("SELECT * FROM citas INNER JOIN mascota ON citas.mascota_idMascota = mascota.idMascota INNER JOIN usuario ON citas.usuario_idUsuario = usuario.idUsuario WHERE citas.estadoCita = 'PENDIENTE' AND citas.veterinario_idVeterinario  = ?");
                                            ) {
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="detalleCitaVeterinario.jsp?id=<%= rs.getString("idCitas") %>" class="btn btn-sm btn-success">
                                                                <i class="fas fa-bars fa-sm text-white-50"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                        <%
