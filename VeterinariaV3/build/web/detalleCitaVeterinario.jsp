    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="listaCitaVeterinario.jsp" class="btn btn-sm btn-warning"><i class="fas fa-list fa-sm text-white-50"></i> Listar</a>
                    </div>
                    <br>
                                        ...
                                        <% 
                                            ...
                                            try (Connection connection = Conexion.obtenerConexion();
                                                PreparedStatement ps1 = connection.prepareStatement(
                                                    "SELECT * FROM citas INNER JOIN mascota ON citas.mascota_idMascota = mascota.idMascota INNER JOIN servicio ON citas.servicio_idServicio = servicio.idServicio INNER JOIN usuario ON citas.usuario_idUsuario = usuario.idUsuario WHERE idCitas = ?")) {
                                                    ...
                                                    try (ResultSet rs1 = ps1.executeQuery()) {
                                                        ...
                                                        tipo = rs1.getInt("tipo_mascota_idTipo_mascota");
                                                        detalle  = rs1.getString("detalle");
                                                        servicio  = rs1.getString("desServicio");
                                                        }
                                                    } catch (SQLException e) {
                                                        e.printStackTrace();
                                                    }
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" value="<% if (tipo == 1) {
        out.print("PERRO");
    } else if (tipo == 2) {
        out.print("GATO");
    } else if (tipo == 3) {
        ...
        out.print("OTRO");
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-6">
                                                    <label for="inputPassword" class="col-sm-4 col-form-label">Servicio</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" value="<%=servicio%>" name="celular" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea type="text" class="form-control"><%= detalle%></textarea>
                                                    </div>
                                                </div
                                            </div>
                                        </div> 
