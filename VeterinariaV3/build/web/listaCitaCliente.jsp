        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <a href="registrarCita.jsp" class="btn btn-sm btn-success"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>
                              ...
                              <div class="card-body">
                                  ...
                                  <table class="table">
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                PreparedStatement ps = conexion.prepareStatement("SELECT * FROM citas INNER JOIN mascota ON citas.mascota_idMascota = mascota.idMascota INNER JOIN servicio ON citas.servicio_idServicio = servicio.idServicio WHERE citas.usuario_idUsuario = ?")){
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%if(rs.getString("estadoCita").equals("PENDIENTE")){ %>        
                                                            <a href="actualizarEstadoCitaCliente?id=<%= rs.getString("idCitas")%>&estado=<%= rs.getString("estadoCita") %>" class="btn btn-sm btn-danger">
