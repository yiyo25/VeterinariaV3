            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="img/team-3.jpg" width="400px"/>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="LoginServlet" method="POST">
                                        <div class="form-group">
                                            <input type="email" name="txtCorreo" class="form-control form-control-user"
                                        ...
                                        <button type="submit" name="verificar" class="btn btn-primary btn-user btn-block">
                                            Iniciar Sesión
                                        </button>
                                    </form>
                                    <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="registro.jsp">¡Crea una cuenta!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
