            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Aistentes</h1>
                    </div>
                    <div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                              <div class="card-body">
                                <h5 class="card-title">Agregar Asistente</h5>
                                <form method="POST" action="registrarAsistente">
                                    <div class="row mb-3">
                                        <label for="inputText" class="col-sm-3 col-form-label">Nombre y Apellidos</label>
                                        <div class="col-sm-9">
