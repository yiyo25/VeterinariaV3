                              ...
                              <div class="card-body">
                                  ...
                                  <table class="table">
                                      ...
                                      <tbody>
                                        <%
                                            try (Connection conexion = Conexion.obtenerConexion();
                                                 PreparedStatement ps = conexion.prepareStatement("SELECT * FROM citas INNER JOIN mascota ON citas.mascota_idMascota = mascota.idMascota INNER JOIN usuario ON citas.usuario_idUsuario = usuario.idUsuario;");
                                        ...
                                        %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="detalleCita.jsp?id=<%= rs.getString("idCitas") %>" class="btn btn-sm btn-warning">
                                                                <i class="fas fa-list fa-sm text-white-50"></i>
                                                            </a>
                                                            <%if(rs.getString("estadoCita").equals("PENDIENTE")){ %>        
                                                            <a href="actualizarEstadoCitas?id=<%= rs.getString("idCitas")%>&estado=<%= rs.getString("estadoCita") %>" class="btn btn-sm btn-danger">
