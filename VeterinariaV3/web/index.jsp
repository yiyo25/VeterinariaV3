        ...
        <div class="row py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-capitalize"><span class="text-primary">Animal</span>VetPro</h1>
                </a>
            </div>
            <div class="col-lg-8 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Email</h6>
                        <p class="m-0">U20237231@utp.edu.pe</p>
                    </div>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                ...
                <button type="button" class="btn btn-danger"><a href="login.jsp" style="color:white">Login</a></button>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button type="button" class="btn btn-danger"><a href="registro.jsp" style="color:white">Registro</a></button>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-3">Veterinaria de confianza para tu fiel compañero</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">"Cuidando la salud y felicidad de tus mascotas, porque son parte de tu familia."</h5>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-3">Salud y alegría para tus mascotas</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">"Cada paciente peludo es único, y nuestro enfoque es personalizado para garantizar su bienestar."</h5>
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-3 display-5 text-capitalize text-white"><span class="text-primary">Animal</span>VetPro</h1>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2"></i>Villa María del Triunfo</p>
                        <p><i class="fa fa-phone-alt mr-2"></i> 345 67890</p>
                        <p><i class="fa fa-envelope mr-2"></i>U20237231@utp.edu.pe</p>
