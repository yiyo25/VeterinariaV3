                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Actualizar Asistente</h5>
                                    <form method="POST" action="actualizarAsistente">
                                        <% 
                                            String nombre = "";
                                            String dni ="";
                                            String celular = "";
                                            ...
                                            try (Connection connection = Conexion.obtenerConexion();
                                                PreparedStatement ps1 = connection.prepareStatement(
                                                    ...
                                                    ps1.setString(1, idAsistente);
                                                    try (ResultSet rs1 = ps1.executeQuery()) {
                                                        while (rs1.next()) {
                                                        nombre = rs1.getString("nomUsuario");
                                                        dni = rs1.getString("dniUsuario");
                                                        celular = rs1.getString("celUsuario");
                                                        correo1 = rs1.getString("emaUsuario");
                                                        password = rs1.getString("pasUsuario");
                                                        }
                                                    } catch (SQLException e) {
                                                        e.printStackTrace();
                                                    }
                                        ...
                                        %>
                                        <input type="hidden" name="idAsistente" value="<%=idAsistente%>">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-6">
                                                    <label for="inputEmail" class="col-sm-4 col-form-label">N° DNI</label>
                                                    <div class="col-sm-8">
                                                        <input type="number" value="<%=dni%>" name="dni" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row mb-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="email" value="<%=correo1%>" name="correo" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
